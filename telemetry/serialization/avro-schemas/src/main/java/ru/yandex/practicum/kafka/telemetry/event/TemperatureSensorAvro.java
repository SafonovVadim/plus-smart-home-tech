...
public class TemperatureSensorAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TemperatureSensorAvro(String id, String hubId, Long timestamp, Integer temperature_c, Integer temperature_f) {
    this.id = id;
    this.hubId = hubId;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: temperature_c = (Integer)value$; break;
    case 4: temperature_f = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new TemperatureSensorAvro RecordBuilder
   */
  public static Builder newBuilder(TemperatureSensorAvro other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TemperatureSensorAvro>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(TemperatureSensorAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    public TemperatureSensorAvro build() {
      try {
        ...
        record.temperature_c = fieldSetFlags()[3] ? this.temperature_c : (Integer) defaultValue(fields()[3]);
        record.temperature_f = fieldSetFlags()[4] ? this.temperature_f : (Integer) defaultValue(fields()[4]);
        return record;
