...
public class MotionSensorAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MotionSensorAvro(Integer link_quality, Boolean motion, Integer voltage) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: link_quality = (Integer)value$; break;
    case 1: motion = (Boolean)value$; break;
    case 2: voltage = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new MotionSensorAvro RecordBuilder
   */
  public static Builder newBuilder(MotionSensorAvro other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MotionSensorAvro>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(MotionSensorAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.link_quality)) {
        this.link_quality = data().deepCopy(fields()[0].schema(), other.link_quality);
    ...
    public MotionSensorAvro build() {
      try {
        ...
        record.link_quality = fieldSetFlags()[0] ? this.link_quality : (Integer) defaultValue(fields()[0]);
        record.motion = fieldSetFlags()[1] ? this.motion : (Boolean) defaultValue(fields()[1]);
        record.voltage = fieldSetFlags()[2] ? this.voltage : (Integer) defaultValue(fields()[2]);
        return record;
