...
public class ClimateSensorAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ClimateSensorAvro(Integer temperature_c, Integer humidity, Integer co2_level) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: temperature_c = (Integer)value$; break;
    case 1: humidity = (Integer)value$; break;
    case 2: co2_level = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new ClimateSensorAvro RecordBuilder
   */
  public static Builder newBuilder(ClimateSensorAvro other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClimateSensorAvro>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ClimateSensorAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.temperature_c)) {
        this.temperature_c = data().deepCopy(fields()[0].schema(), other.temperature_c);
    ...
    public ClimateSensorAvro build() {
      try {
        ...
        record.temperature_c = fieldSetFlags()[0] ? this.temperature_c : (Integer) defaultValue(fields()[0]);
        record.humidity = fieldSetFlags()[1] ? this.humidity : (Integer) defaultValue(fields()[1]);
        record.co2_level = fieldSetFlags()[2] ? this.co2_level : (Integer) defaultValue(fields()[2]);
        return record;
